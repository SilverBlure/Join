...
/**
 * Handhabt das Verschieben einer Aufgabe von einer Quellliste in eine Zielliste.
 * 
 * @param {Event} event - Das Drag-and-Drop-Event.
 * @param {string} targetListId - Die ID der Liste, in die die Aufgabe verschoben werden soll.
